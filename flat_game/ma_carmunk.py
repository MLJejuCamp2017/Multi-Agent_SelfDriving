...
class GameState():
    ...
    def __init__(self, numCars = 12, draw_screen=True):
        self.crashed = False
        self.w = width
        self.h = height
        # physics stuff.
        ...
        self.multiAgent = MultiAgentCar(lane1, lane2, self.space, self.w, self.h, 
            goal=[self.rewardRed, self.rewardGreen], numCar=self.numCar)
...
class MultiAgentCar():
    def __init__(self, lane1, lane2, space, width, height, goal, numCar=12):
        self.maxCar = 48
        self.car_radius = 25
        self.width = width
        self.height = height
    ...
    def checkRewards(self):
        ...
        dones = []
        for i in xrange(self.numCar):
            reward, done = self.Cars[i].get_reward()
